  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .tips { background-color: #EFF6FF; padding: 15px; border-radius: 4px; margin: 20px 0; }
        .tips-title { color: #1E40AF; font-weight: bold; margin-bottom: 10px; }
    ...
    <body>
      <div class="container">
        <div class="content">
          ...
          <p>您正在申请重置实验室管理系统的密码。请使用以下验证码完成验证：</p>
          
          <div class="code-box">
            <div style="font-size: 14px; margin-bottom: 10px;">您的验证码</div>
            <div class="code">${code}</div>
            <div style="font-size: 14px; margin-top: 10px;">验证码15分钟内有效</div>
          </div>
          
          <div class="info">
            <p class="warning">⚠️ 重要提示：</p>
            <ul style="margin: 10px 0;">
              <li>验证码有效期为 <strong>15分钟</strong></li>
              <li>最多可尝试输入 <strong>5次</strong></li>
              <li>请勿将验证码透露给他人</li>
            </ul>
          </div>
          ...
          <div class="tips">
            ...
            <ul>
              ...
              <li>请确保您的新密码足够安全（至少6位字符）</li>
              <li>建议定期更换密码以保护账户安全</li>
            </ul>
          </div>
          
          <p style="margin-top: 30px;">如有任何问题，请联系系统管理员。</p>
